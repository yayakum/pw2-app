        ...
        <div className="flex items-center justify-around">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative group">
              <button className="flex items-center space-x-2 p-1 rounded-full hover:bg-gray-700  hover:scale-105 duration-300 cursor-pointer">
                <img
                  src="/neji.jfif"
                  alt="Profile"
            ...
            <button className="p-2 rounded-full hover:bg-gray-700 relative cursor-pointer hover:scale-105 duration-300">
              <LogOut size={24} />
